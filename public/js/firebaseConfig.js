...
import { getFirestore, doc, setDoc, getDoc, getDocs, addDoc, collection, serverTimestamp, query, where, updateDoc, increment, orderBy, limit, Timestamp} from "https://www.gstatic.com/firebasejs/11.5.0/firebase-firestore.js";
...
export { app, auth, db, onAuthStateChanged, doc, setDoc, getDoc, getDocs, addDoc, collection, query, where, createUserWithEmailAndPassword, signInWithEmailAndPassword, serverTimestamp, Timestamp, updateDoc, increment, orderBy, limit};
